...
public class StatService {
	...
	public boolean doingNumStat(int start, int perpage) {
		boolean next = false;
		Map<Integer, Integer> updates = new HashMap<Integer, Integer>();
		List<Map<String, Object>> list = dataBaseDao.executeQuery("SELECT uid, doingnum FROM "+ JavaCenterHome.getTableName("space") + " LIMIT " + start + "," + perpage);
		for (Map<String, Object> value : list) {
			next = true;
			int count = dataBaseDao.findRows("SELECT COUNT(*) FROM " + JavaCenterHome.getTableName("doing")+ " WHERE uid='" + value.get("uid") + "'");
		...
		Map<Integer, List<Integer>> num1 = (Map<Integer, List<Integer>>) nums[1];
		for (Integer num : num0) {
			dataBaseDao.executeUpdate("UPDATE " + JavaCenterHome.getTableName("space") + " SET doingnum=" + num+ " WHERE uid IN (" + Common.sImplode(num1.get(num)) + ")");
		}
		return next;
	}
	public boolean albumNumStat(int start, int perpage) {
		boolean next = false;
		Map<Integer, Integer> updates = new HashMap<Integer, Integer>();
		List<Map<String, Object>> list = dataBaseDao.executeQuery("SELECT uid, albumnum FROM "+ JavaCenterHome.getTableName("space") + " LIMIT " + start + "," + perpage);
		for (Map<String, Object> value : list) {
			next = true;
			int count = dataBaseDao.findRows("SELECT COUNT(*) FROM " + JavaCenterHome.getTableName("album")+ " WHERE uid='" + value.get("uid") + "'");
		...
		Map<Integer, List<Integer>> num1 = (Map<Integer, List<Integer>>) nums[1];
		for (Integer num : num0) {
			dataBaseDao.executeUpdate("UPDATE " + JavaCenterHome.getTableName("space") + " SET albumnum=" + num+ " WHERE uid IN (" + Common.sImplode(num1.get(num)) + ")");
		}
		return next;
	}
	public boolean threadNumStat(int start, int perpage) {
		boolean next = false;
		Map<Integer, Integer> updates = new HashMap<Integer, Integer>();
		List<Map<String, Object>> list = dataBaseDao.executeQuery("SELECT uid, threadnum FROM "+ JavaCenterHome.getTableName("space") + " LIMIT " + start + "," + perpage);
		for (Map<String, Object> value : list) {
			next = true;
			int count = dataBaseDao.findRows("SELECT COUNT(*) FROM " + JavaCenterHome.getTableName("thread")+ " WHERE uid='" + value.get("uid") + "'");
			if (count != (Integer) value.get("threadnum")) {
				updates.put((Integer) value.get("uid"), count);
			}
		}
		...
		Map<Integer, List<Integer>> num1 = (Map<Integer, List<Integer>>) nums[1];
		for (Integer num : num0) {
			dataBaseDao.executeUpdate("UPDATE " + JavaCenterHome.getTableName("space") + " SET threadnum=" + num+ " WHERE uid IN (" + Common.sImplode(num1.get(num)) + ")");
		}
		return next;
	}
	public boolean pollNumStat(int start, int perpage) {
		boolean next = false;
		Map<Integer, Integer> updates = new HashMap<Integer, Integer>();
		List<Map<String, Object>> list = dataBaseDao.executeQuery("SELECT uid, pollnum FROM "+ JavaCenterHome.getTableName("space") + " LIMIT " + start + "," + perpage);
		for (Map<String, Object> value : list) {
			next = true;
			int count = dataBaseDao.findRows("SELECT COUNT(*) FROM " + JavaCenterHome.getTableName("poll")+ " WHERE uid='" + value.get("uid") + "'");
		...
		Map<Integer, List<Integer>> num1 = (Map<Integer, List<Integer>>) nums[1];
		for (Integer num : num0) {
			dataBaseDao.executeUpdate("UPDATE " + JavaCenterHome.getTableName("space") + " SET pollnum=" + num+ " WHERE uid IN (" + Common.sImplode(num1.get(num)) + ")");
		}
		return next;
	}
	public boolean eventNumStat(int start, int perpage) {
		boolean next = false;
		Map<Integer, Integer> updates = new HashMap<Integer, Integer>();
		List<Map<String, Object>> list = dataBaseDao.executeQuery("SELECT uid, eventnum FROM "+ JavaCenterHome.getTableName("space") + " LIMIT " + start + "," + perpage);
		for (Map<String, Object> value : list) {
			next = true;
			int count = dataBaseDao.findRows("SELECT COUNT(*) FROM " + JavaCenterHome.getTableName("event")+ " WHERE uid='" + value.get("uid") + "'");
		...
		Map<Integer, List<Integer>> num1 = (Map<Integer, List<Integer>>) nums[1];
		for (Integer num : num0) {
			dataBaseDao.executeUpdate("UPDATE " + JavaCenterHome.getTableName("space") + " SET eventnum=" + num+ " WHERE uid IN (" + Common.sImplode(num1.get(num)) + ")");
		}
		return next;
	}
	public boolean shareNumStat(int start, int perpage) {
		boolean next = false;
		Map<Integer, Integer> updates = new HashMap<Integer, Integer>();
		List<Map<String, Object>> list = dataBaseDao.executeQuery("SELECT uid, sharenum FROM "+ JavaCenterHome.getTableName("space") + " LIMIT " + start + "," + perpage);
		for (Map<String, Object> value : list) {
			next = true;
			int count = dataBaseDao.findRows("SELECT COUNT(*) FROM " + JavaCenterHome.getTableName("share")+ " WHERE uid='" + value.get("uid") + "'");
		...
		Map<Integer, List<Integer>> num1 = (Map<Integer, List<Integer>>) nums[1];
		for (Integer num : num0) {
			dataBaseDao.executeUpdate("UPDATE " + JavaCenterHome.getTableName("space") + " SET sharenum=" + num+ " WHERE uid IN (" + Common.sImplode(num1.get(num)) + ")");
		}
		return next;
	}
}
