...
<div class="mainarea">
	<div class="maininner">
		<div class="tabs_header">
			<ul class="tabs">
				<li${actives_view}><a href="admincp.jsp?ac=task"><span>浏览全部任务</span></a></li>
				<li class="null"><a href="admincp.jsp?ac=task&op=add">添加新任务</a></li>
			</ul>
		</div>
		<form method="post" action="admincp.jsp?ac=task&taskid=${taskid}">
						...
						<table cellspacing="0" cellpadding="0" class="formtable">
							...
							<c:forEach items="${tasks}" var="task">
								<tr>
									...
									<td><a href="admincp.jsp?ac=task&op=edit&taskid=${task.taskid}">编辑</a>&nbsp;|&nbsp;<a href="admincp.jsp?ac=task&op=delete&taskid=${task.taskid}">删除</a></td>
								</tr>
							</c:forEach>
						</table>
					</div>
